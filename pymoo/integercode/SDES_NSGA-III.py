...
path = None
# path = 'Results/obj5target50/GeneticMOSGinteger-AblationLcodePopsize400Codeintegergen100-2022_05_17_14_28-520716.txt'
if path is not None:
    ...
    for obj_idx, obj_n in enumerate(obj_np):
        for target_idx, target_n in enumerate(target_np):  
            ...
            for SEED in SEED_list:
                ...
                for pop_size in [400]:
                    ref_num = pop_size
                    gen_n = 300 # for Comparision NaiveEA and ORIGAMIG
                    if obj_n == 3:
                        # pop_size  = 50
                        # ref_num = pop_size
                        gen_n = 50
